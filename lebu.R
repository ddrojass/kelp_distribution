...
# summer15 
R_summer15 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/summer15.tif")  
...
# autumn16 
R_autumn16 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/autumn16.tif")
...
# winter16 
R_winter16 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/winter16.tif")
...
# spring16 
R_spring16 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/spring16.tif")
...
# summer16 
R_summer16 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/summer16.tif")
...
# autumn17 
R_autumn17 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/autumn17.tif")
...
# winter17 
R_winter17 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/winter17.tif")
...
# spring17 
R_spring17 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/spring17.tif")
...
# summer17 
R_summer17 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/summer17.tif")
...
# autumn18 
R_autumn18 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/autumn18.tif")
...
# winter18 
R_winter18 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/winter18.tif")
...
# spring18 
R_spring18 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/spring18.tif")
...
# summer18 
R_summer18 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/summer18.tif")
...
# autumn19 
R_autumn19 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/autumn19.tif")
...
# winter19 
R_winter19 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/winter19.tif")
...
# spring19 
R_spring19 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/spring19.tif")
...
# summer19 
R_summer19 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/summer19.tif")
...
# autumn20 
R_autumn20 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/autumn20.tif")
...
# winter20 
R_winter20 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/winter20.tif")
...
# spring20 
R_spring20 <- raster("~/Documents/R Studio/macrocystis/julio/lebu/spring20.tif")
...
kelp_lebu_data <- bind_rows(summer15, autumn16, winter16, spring16,  
                                summer17, autumn18, winter18, spring18, 
                                summer18, autumn19, winter19, spring19, 
                                summer19, autumn20, winter20, spring20)

#kelp_lebu <- kelp_lebu_data %>% filter(KD > 0)
#saveRDS(kelp_lebu, "~/Documents/R Studio/macrocystis/data/KD/lebu")
...
ggplot() +
  ...
  geom_bin2d(data = kelp_lebu, aes(x = Lon, y = Lat), bins = 30) +
